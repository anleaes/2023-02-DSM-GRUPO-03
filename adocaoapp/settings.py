"""
Django settings for adocaoapp project.
...
# SECRET_KEY = 'django-insecure-pd41y69=ur*jp_=adit!$%%pme#uj&dzbw$lkw7nyf941!m7b9'
...
INSTALLED_APPS = [
    ...
    'adocaos.apps.AdocaosConfig',
    'animaisadotados.apps.AnimaisadotadosConfig',
]
